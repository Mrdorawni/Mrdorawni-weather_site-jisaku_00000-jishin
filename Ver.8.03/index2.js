...
map.createPane("overlayLayer_map").style.zIndex = 11; 
map.createPane("kenkyo-1").style.zIndex = 12; 
map.createPane("kenkyo-2").style.zIndex = 13; 
...
fetch('source/geojson/japan-lite.geojson')
            ...
            .then(data => {
                ...
                }).addTo(todofukenLayer1);
            });

var todofukenLayer2 = L.geoJSON();
...
fetch('source/geojson/japan-lite.geojson')
            ...
            .then(data => {
                ...
                }).addTo(todofukenLayer2);
            });


            var sekaiLayer1 = L.geoJSON();
...
var ineiL = L.layerGroup([inei, worldG]);
var todofukenLayer = L.layerGroup([todofukenLayer1, todofukenLayer2]);
var sekaiLayer = L.layerGroup([sekaiLayer1, sekaiLayer2]);
...
L.control.layers(null,{
    ...
    "g地図(透過)": google4,  
        ...
        map.on('baselayerchange', function(e) {
            ...
            } else if (e.name === '地理院陰影起伏図') {
                changeBackgroundGradient('linear-gradient(180deg, lightblue, lightblue)'); // Area 2が表示された場合
            }
        });
    ...
    $.getJSON(url, function (data) {
        ...
        if (QuakeJson[num]["issue"]["type"] != "ScalePrompt") { //各地の震度に関する情報
            ...
            if (result != -1) {
                ...
                var PointShindo = "";
                if (element["scale"] == 10) {
                    ImgUrl ="https://mrdorawni.github.io/Mrdorawni-weather_site-jisaku_00000-jishin/source/shindo/wni/wni_int1.png";
                    PointShindo = "震度1";
                }
                else if (element["scale"] == 20) {
                    ImgUrl ="https://mrdorawni.github.io/Mrdorawni-weather_site-jisaku_00000-jishin/source/shindo/wni/wni_int2.png";
                    PointShindo = "震度2";
                }
                else if (element["scale"] == 30) {
                    ImgUrl ="https://mrdorawni.github.io/Mrdorawni-weather_site-jisaku_00000-jishin/source/shindo/wni/wni_int3.png";
                    PointShindo = "震度3";
                }
                else if (element["scale"] == 40) {
                    ImgUrl ="https://mrdorawni.github.io/Mrdorawni-weather_site-jisaku_00000-jishin/source/shindo/wni/wni_int4.png";
                    PointShindo = "震度4";
                }
                else if (element["scale"] == 45) {
                    ImgUrl ="https://mrdorawni.github.io/Mrdorawni-weather_site-jisaku_00000-jishin/source/shindo/wni/wni_int5-.png";
                    PointShindo = "震度5弱";
                }
                    ...
                    ImgUrl ="https://mrdorawni.github.io/Mrdorawni-weather_site-jisaku_00000-jishin/source/shindo/wni/wni_int6-.png";
                    PointShindo = "震度6弱";
                }
                    ...
                    ImgUrl ="https://mrdorawni.github.io/Mrdorawni-weather_site-jisaku_00000-jishin/source/shindo/wni/wni_int7.png";
                    PointShindo = "震度7";
                }
                else {
                    ImgUrl ="https://mrdorawni.github.io/Mrdorawni-weather_site-jisaku_00000-jishin/source/shindo/wni/wni_int_?.png";
                    PointShindo = "震度不明";
                }
